...
export class Socket_Grupos {
    ...
    private _Grupos: any; // instancia da classe de controle de permissoes
    ...
    constructor(_config: Modelo_Config, _bd: Conector_Mysql, _core_conection: Socket_Client) {
        ...
        /**
         * TODO Classe de controle de grupos
         */
        this._Grupos = null;
    }
    ...
    Inicializar_Listeners() {
        ...
        this._Core_Conection.socketClient.on("grupos/Listar", (dadosRetorno: Pacotes_Socket, callback = (...retorno_callback: any) => { }) => {
            this._Logger.Error("Ao realizar uma call nao implementada", dadosRetorno);
            throw "Não Implementado"
        })
        // Adiciona os listeners de eventos do Socket
        this._Core_Conection.socketClient.on("grupos/Adicionar", (dadosRetorno: Pacotes_Socket, callback = (...retorno_callback: any) => { }) => {
            this._Logger.Error("Ao realizar uma call nao implementada", dadosRetorno);
            throw "Não Implementado"
        })
        // Adiciona os listeners de eventos do Socket
        this._Core_Conection.socketClient.on("grupos/Editar", (dadosRetorno: Pacotes_Socket, callback = (...retorno_callback: any) => { }) => {
            this._Logger.Error("Ao realizar uma call nao implementada", dadosRetorno);
            throw "Não Implementado"
        })
        // Adiciona os listeners de eventos do Socket
        this._Core_Conection.socketClient.on("grupos/Remover", (dadosRetorno: Pacotes_Socket, callback = (...retorno_callback: any) => { }) => {
            this._Logger.Error("Ao realizar uma call nao implementada", dadosRetorno);
            throw "Não Implementado"
        })
    }
