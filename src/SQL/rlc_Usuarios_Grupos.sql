...
CREATE TABLE IF NOT EXISTS rlc_Usuarios_Grupos(
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    id_usuarios BIGINT COMMENT "Id referenciando a tabela usuarios",
    id_grupos BIGINT COMMENT "Id referenciando a tabela Grupos",
